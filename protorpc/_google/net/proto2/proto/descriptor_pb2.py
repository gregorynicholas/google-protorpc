...
from libs.google.net.proto2.python.public import descriptor
from libs.google.net.proto2.python.public import message
from libs.google.net.proto2.python.public import reflection
...
_STREAMOPTIONS = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='uninterpreted_option', full_name='proto2.StreamOptions.uninterpreted_option', index=2,
      number=999, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
